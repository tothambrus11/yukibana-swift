...
var worker_default = {
  async fetch(request, env) {
    ...
    const cf = { cacheEverything: true, cacheTtl: 31536e3 };
...
`, {
    ...
    const body = gzipped ? upstream.body.pipeThrough(new DecompressionStream("gzip")) : upstream.body;
...
// .wrangler/tmp/bundle-kLrbA1/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-kLrbA1/middleware-loader.entry.ts
